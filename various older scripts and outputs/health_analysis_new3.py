...
# Adjusted layout to prevent all overlapping text.
plt.subplots_adjust(left=0.1, right=0.9, top=0.92, bottom=0.05, hspace=0.8, wspace=0.3)
plt.show()

# --- Normalized Statistics Heatmap ---
# This section was added back from the original script.
# It normalizes key stats to visualize their relative variability.
