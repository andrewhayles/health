...
# --- UPDATED: Define units for the health markers ---
units = {
    'WEIGHT': 'kg',
...
# --- UPDATED: Generate and display summary table with units ---
table_data = []
for col in df.columns:
    unit = units.get(col, 'N/A')
    table_data.append([
        col,
        unit,
...
# --- UPDATED: Static Distribution Plots with Units ---
...
for i, col in enumerate(df.columns):
    ...
    # Only add units to the title if they are specified and not 'N/A'
