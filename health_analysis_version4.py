...
def plot_sleep_correlation(df):
    """
    Plots a correlation matrix of metrics vs. the previous night's sleep,
    ...
    plt.title("Correlation Matrix: Metrics vs. Previous Night's Sleep (p < 0.05)", fontsize=16)
...
def main():
    ...
    plot_sleep_correlation(health_df)
